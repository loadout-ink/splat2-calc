...
var it_strings = {
  ...
  "STAT_SAVER_MAIN_ROLLING": "Ink Consumption (Main): Rolling",
  "STAT_SAVER_MAIN_FLICK": "Ink Consumption (Main)",
  "STAT_SAVER_MAIN_HORIZONTAL_FLICK": "Ink Consumption (Main): Horizontal",
  "STAT_SAVER_MAIN_VERTICAL_FLICK": "Ink Consumption (Main): Vertical",
  ...
  "STAT_SUB_POWER_TRACKING_TIME": "Sub Power (Tracking Time)",
  ...
  "STAT_MAIN_POWER_UP_GROUND_SHOT_RANDOMIZATION": "Main Power Up (Ground Shot Randomization)",
  ...
  "STAT_MAIN_POWER_UP_DAMAGE_RADIUS": "Main Power Up (Damage Radius)",
  "STAT_MAIN_POWER_UP_HIGH_DAMAGE_RADIUS": "Main Power Up (High Damage Radius)",
  "STAT_MAIN_POWER_UP_DASH_SPEED": "Main Power Up (Dash Speed)",
  "STAT_MAIN_POWER_UP_INK_TRAIL_SIZE": "Main Power Up (Ink Trail Size)",
  "STAT_MAIN_POWER_UP_FULL_CHARGE_DISTANCE": "Main Power Up (Full Charge Distance)",
  "STAT_MAIN_POWER_UP_PARTIAL_CHARGE_DISTANCE": "Main Power Up (Partial Charge Distance)",
  "STAT_MAIN_POWER_UP_ROLLING_MIN_DAMAGE": "Main Power Up (Rolling Min Damage)",
  "STAT_MAIN_POWER_UP_ROLLING_MAX_DAMAGE": "Main Power Up (Rolling Max Damage)",
  "STAT_MAIN_POWER_UP_STANDING_MIN_DAMAGE": "Main Power Up (Standing Min Damage)",
  "STAT_MAIN_POWER_UP_STANDING_MAX_DAMAGE": "Main Power Up (Standing Max Damage)",
  "STAT_MAIN_POWER_UP_JUMPING_MIN_DAMAGE": "Main Power Up (Jumping Min Damage)",
  "STAT_MAIN_POWER_UP_JUMPING_MAX_DAMAGE": "Main Power Up (Jumping Max Damage)",
  ...
  "STAT_MAIN_POWER_UP_REPEAT_MIN_DAMAGE": "Main Power Up (Repeat Min Damage)",
  "STAT_MAIN_POWER_UP_REPEAT_MAX_DAMAGE": "Main Power Up (Repeat Max Damage)",
  "STAT_MAIN_POWER_UP_MAX_DAMAGE_RANGE": "Main Power Up (Max Damage Range)",
  "STAT_MAIN_POWER_UP_FIRST_RING_BURST_DURATION": "Main Power Up (First Ring Burst Duration)",
